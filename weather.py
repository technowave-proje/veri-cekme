...
for state in states:
    ...
    url = f"https://api.openweathermap.org/data/2.5/weather?lat={state['lat']}&lon={state['lon']}&appid={API_KEY}&units=metric&lang=tr"
    ...
    """, (
        state['state'], state['country'], state['lat'], state['lon'], temp, feels_like, humidity, pressure,
